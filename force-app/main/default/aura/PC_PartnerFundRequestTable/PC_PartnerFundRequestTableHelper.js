        ...
        action.setCallback(this,function(response){
            ...
            if(response.getState() == "SUCCESS"){
                ...
                records.forEach(function(record){
                    record.linkName = pathname+'/s/marketingfundsdetail?recordId='+record.Id+'&recordName='+record.Title;
                    var activityEndDate = new Date(record.Activity_End_Date__c);
                    if(record.MDF_Request_Closed__c){
                        record.disableButton = true;
                        record.Status = 'Completed';
                    }
                    
                     if(record.Is_Expired__c){
                        record.disableButton = true;
                    }
