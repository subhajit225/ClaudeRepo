...
export default class Pc_amplifyTermsOfUse extends LightningElement {
    baseUrl = basepath;
    partnerType = 'All';
    masterUrl;
    error;
    ...
    openMasterModal(){
        if(this.partnerType != "" && this.contact.Email != ""){
            ...
            this.masterUrl = this.baseUrl + '/apex/Pactsafe?groupType=RubrikAmplifyTerms&partnerType=' + this.partnerType +'&email=' + this.contact;
            window.addEventListener("message", (event) => {
                if (event.data.name === "RubrikAmplifyTerms") {
                    // Handle the message
    ...
    saveContact(){
        ...
        this.contactUpdate.Partner_Rubrik_Amplify_Terms__c = true;
