...
import search from "@salesforce/apex/su_vf_console.SUVFConsoleController.search";

export default class SU_EmailInput extends LightningElement {
    @track items = [];
    searchTerm = "";
    blurTimeout;
    firstLoad = true;
    ...
    @api 
    set toEmail(value){
        if (this.firstLoad && value && value.length) {
