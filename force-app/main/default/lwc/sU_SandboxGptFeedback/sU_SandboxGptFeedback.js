...
import { registerListener, unregisterListener } from "c/supubsub";


export default class SU_SandboxGptFeedback extends LightningElement {
    @api searchString;
    @api gptContext;
    @api gptResponse;
    @track responseIssue = '';
    ...
    connectedCallback() {
        ...
        registerListener('gptResponse'+this.eventCode, this.getGptResponse, this);
        registerListener('getGptSandboxVal'+this.eventCode, this.updateSandboxFeedbackVisibility, this);
    }
    ...
    disconnectedCallback() {
        unregisterListener('gptResponse'+this.eventCode, this.getGptResponse, this);
        unregisterListener('getGptSandboxVal'+this.eventCode, this.getGptSandboxVal, this);
    }
    ...
    submitSandboxFeedback() {
        ...
        //Clear radio selections manually
        this.template.querySelectorAll('[id^="feedback-input"]').forEach(input => {
            input.checked = false;
        });
        setTimeout(() => {
